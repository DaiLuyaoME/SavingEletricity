...
{
    ui->setupUi(this);
    testModel.setHorizontalHeaderItem(0, new QStandardItem(QString("before")));
    testModel.setHorizontalHeaderItem(1, new QStandardItem(QString("after")));
    testModel.setHorizontalHeaderItem(2, new QStandardItem(QString("ratio")));
